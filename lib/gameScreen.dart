...
import 'package:zero_cross/button.dart';
import 'package:zero_cross/customButton.dart';

class GameScreen extends StatefulWidget {
  final player1, player2, player1Color, player2Color;
  GameScreen(
      {this.player1, this.player2, this.player1Color, this.player2Color});
  @override
  _GameScreenState createState() => _GameScreenState();
}

class _GameScreenState extends State<GameScreen> {
  late List<Btn> buttons;
  var active;
  List p1 = [], p2 = [];
  late Color p1Color, p2Color;
  ...
  getColor() {
    switch (widget.player1Color) {
      case "Red":
        ...
        break;
      case "Black":
        p1Color = Colors.black;
        break;
      case "Pink":
        p1Color = Colors.pink;
        break;
      case "Green":
        p1Color = Colors.green;
        break;
      case "Blue":
        p1Color = Colors.blue;
        break;
    ...
    switch (widget.player2Color) {
      case "Red":
        ...
        break;
      case "Black":
        p2Color = Colors.black;
        break;
      case "Pink":
        p2Color = Colors.pink;
        break;
      case "Green":
        p2Color = Colors.green;
        break;
      case "Blue":
        p2Color = Colors.blue;
        break;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Zero Cross",  style: TextStyle(fontWeight: FontWeight.bold),),
        centerTitle: true,
        actions: <Widget>[
          IconButton(
        ...
        child: Column(
            ...
            children: <Widget>[
                  ...
                  itemBuilder: (context, int index) {
                    return SizedBox(
                      ...
                      child: MaterialButton(
                        onPressed: buttons[index].enabled
                            ? () => tapButton(buttons[index])
                            : null,
                        child: new Text(
                          buttons[index].text,
                          textScaleFactor: 4,
              ...
              active == 1
                  ? Center(
                      child: Text(
                        ...
                        textScaleFactor: 1.7,
                        style: TextStyle(
                            fontWeight: FontWeight.bold, color: p1Color),
                      ),
                    )
                  : Center(
                      child: Text("${widget.player2}'s turn",
                          textScaleFactor: 1.7,
                          style: TextStyle(
                              fontWeight: FontWeight.bold, color: p2Color))),
              ...
              CustomButton(
                  text: "Reset Game",
                  callback: () =>
                      alert("Reset game", "Press Yes to play again"))
            ]),
      ),
    );
  }
